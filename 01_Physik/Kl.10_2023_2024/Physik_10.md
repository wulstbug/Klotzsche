...
$\textcircled{\textbf{1}} s = \dfrac{1}{2} \cdot a \cdot t^2$  $\hspace{1cm} \textcircled{\textbf{2}} v=a \cdot t$
...
$\hspace{0.5cm}$ Beschleunigende Kraft {9}{$F_R \rightarrow F_R = m \cdot a $} {10}{$\Big\vert :m$}
*************************
