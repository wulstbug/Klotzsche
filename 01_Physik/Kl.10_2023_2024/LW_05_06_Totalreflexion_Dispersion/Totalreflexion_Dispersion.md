...
> d = <input type="number" default="0" min="0" max="10" > m $ \hspace{1cm}$ a = <input type="number" default="0" min="0" max="10" >m $\hspace{1cm}$ e = <input type="number" default="0" min="0" max="10" >m
***************
