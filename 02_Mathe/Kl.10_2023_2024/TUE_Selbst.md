...
5. ![Netz](https://diversewolken.ddns.net/nextcloud/index.php/apps/files_sharing/publicpreview/JHpKkdMbywni35H?file=/&fileId=114369&x=1680&y=1050&a=true&etag=4fea04beb8e0b1dfca2d3ff02dcf77e6)<!--onerror="this.src='TUE/Netz_5.png'"--> Die Abbildung zeigt das Netz des folgenden Körpers.<br> Pyramide, Prisma, Tetraeder, Quader, Kreiskegel <br>{5}{<span style="color:orange">Prisma</span>}
...
8. Der Oberflächeninhalt eines geraden Kreiszylinders wird mit der Formel $A_0 = 2\cdot\pi\cdot r\cdot(r+h)$ berechnet. Stellen Sie die Formel nach h um.
    ...
    {8}{<span style="color:orange"> $A_0 = 2\cdot\pi\cdot r\cdot(r+h)\,\Big\vert :2\pi$ <br> <br>
