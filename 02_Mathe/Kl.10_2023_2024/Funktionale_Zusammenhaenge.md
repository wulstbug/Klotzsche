...
{4}{> (<span style="color:blue">***streng***</span>) monton wachsend: Eine Funktion heißt <span style="color:blue">***streng***</span> monoton wachsend, wenn bei größerem Argument x der Funktionswert größer wird, d.h. }
