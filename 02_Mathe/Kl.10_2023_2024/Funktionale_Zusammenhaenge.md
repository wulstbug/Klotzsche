...
| :--------- | :--------- | :--------- |
|a) $f(x) = \sqrt{\dfrac{1}{x}}$  |{1}{<span style="color:orange">Verkettung</span>}         |{1}{<span style="color:orange">$u(x)=\sqrt{x},\,v(x)=\dfrac{1}{x}$</span>}   |
|b) $f(x) = 3x^2 +2x$             |{1}{<span style="color:orange">Verknüpfung (u+v)</span>}  |{1}{<span style="color:orange">$u(x)=3x^2,\,v(x)=2x$</span>}          |
|c) $f(x) = e^{\sin(x)}$          |{1}{<span style="color:orange">Verkettung</span>}         |{1}{<span style="color:orange">$u(x)=e^x,\,v(x)=\sin(x)$</span>}      |
|d) $f(x) = \dfrac{1}{(-4x+2)^2}$ |{1}{<span style="color:orange">Verknüpfung (u:v) </span>} |{1}{<span style="color:orange">$u(x)=\dfrac{1}{x},\,v(x)=(-4x+2)^2$</span>}     |
