...
|c) $f(x) = e^{\sin(x)}$          |{1}{<span style="color:orange">***Verkettung (u+v): $u(x)=e^x,\,v(x)=\sin(x)$***</span>}      |
|d) $f(x) = \dfrac{1}{(-4x+2)^2}  |{1}{<span style="color:orange">***Verknüpfung (u+v): $u(x)=e^x,\,v(x)=\sin(x)$***</span>}                                                                   |
