...
2. Es seien: $g(x) = x+1$ $\hspace{0.5cm}$ $h(x)=x^2$ $\hspace{0.5cm}$ $k(x)=\dfrac{1}{x}$ $\hspace{0.5cm}$ $l(x)=\sqrt{x}$ $\hspace{0.5cm}$ $s(x)=\sin(x)$. Drücke die Funktion f durch eine geeignete Auswahl von $g,h,k,l,s$ aus.
